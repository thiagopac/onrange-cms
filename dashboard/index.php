...
#INICIO LOGICA
	...
	if (ISSET($LOCAL_SELECIONADO)) {
		...
		//***** Quantidade de promos no mÃªs atual
		...
		//***** Percentual de penetraÃ§Ã£o
		
		if($LOCAL_SELECIONADO != 0){
		
			//Determina a posiÃ§Ã£o e o tipo do local
			...
			//Determina a regiÃ£o onde buscar por outros locais para a comparaÃ§Ã£o. 
			//Por padrÃ£o o local estarÃ¡ no centro de um quadrado com o lado = $RAIO*2.
			...
			//Seleciona a quantidade total de checkins correntes dentro do range, cujo tipo Ã© o mesmo
